...
const nightEncounters = {
    ...
    19: {
        ...
        get init() {
            this.rules = `This random encounter occurs only once. If it comes up again, treat the result as no encounter.<br>If the characters follow the flickering light, read:<span class=description>The torchlight flutters as it moves away from you, but you never lose sight of it. You make your way quickly yet cautiously through the fog until you come upon the shell of a ruined tower. The upper floors of the structure have collapsed, leaving heaps of rubble and shattered timber around the tower’s base. The feeble light moves through an open doorway on the ground floor, then flickers and goes out.</span>The light is a will-o’-wisp that enters the ruined tower and becomes invisible, hoping to lure the characters inside to their doom.<br>The floor of the tower is made of packed earth. Its interior is desecrated ground. Against the inside wall of the tower, across from the open doorway, is a closed, empty wooden chest.<br>If the characters disturb the chest, ${roll('3d6')} zombies erupt from the earthen floor and attack. Once the zombies appear, the will-o’-wisp becomes visible and joins the fray.<br><strong>Desecrated Ground:</strong> a detect evil and good spell cast within range reveals the presence of desecrated ground, and undead standing on desecrated ground have advantage on all saving throws. A vial of holy water purifies a 10-foot-square area of desecrated ground when sprinkled on it, and a hallow spell purifies desecrated ground within its area.`
